 ...
 * Tests the core business logic without React Query dependencies
 */
const updatePayment = async (
  ...
  const tokenCookie =
    typeof window !== "undefined" && window.document && window.document.cookie
      ? window.document.cookie.split("; ").find((row) => row.startsWith("token="))
      : null;
