...
Do not add comments that restate what the code does — only add comments where the _why_ is non-obvious. Do not gold-plate: implement exactly what is needed, no speculative abstractions.
