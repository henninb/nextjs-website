...
const CategoryCard = React.memo<CategoryCardProps>(({ category, onDelete }) => {
  ...
  const isUnused = !category.categoryCount || category.categoryCount === 0;
  const statusColor = category.activeStatus
      ...
      <CardContent sx={{ flexGrow: 1, p: 2.5 }}>
        ...
        <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", mb: 2 }}>
          <Chip
            ...
            label={category.activeStatus ? "Active" : "Inactive"}
            size="small"
            sx={{
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <Typography variant="caption" color="text.secondary">
            {category.categoryCount === 1 ? "transaction" : "transactions"}
          </Typography>
        </Box>
