...
interface DescriptionFilterBarProps {
  searchTerm: string;
...
const DescriptionFilterBar: React.FC<DescriptionFilterBarProps> = ({
  searchTerm,
  onSearchChange,
  activeFilters,
  onFilterChange,
        ...
        <Typography variant="body2" color="text.secondary">
          {resultCount !== undefined && totalCount !== undefined ? (
            <>
              ...
              <strong>{totalCount}</strong> description
              {totalCount !== 1 ? "s" : ""}
...
export default DescriptionFilterBar;
