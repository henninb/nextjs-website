      ...
      >
          ...
          {(["cleared", "outstanding", "future"] as TransactionState[]).map(
            (state) => (
              <Chip
                ...
                variant={
                  transaction.transactionState === state ? "filled" : "outlined"
                }
        ...
        <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
          <Chip
            ...
            variant="outlined"
          />
          <Chip label={getReoccurringLabel()} size="small" variant="outlined" />
        </Stack>
          ...
          <Box sx={{ mt: "auto" }}>
            ...
            >
              ...
              {transaction.notes!.length > 100 && (
                <IconButton size="small" onClick={toggleNotes} sx={{ p: 0.5 }}>
                  {notesExpanded ? (
