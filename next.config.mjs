          ...
          // Content Security Policy - much more restrictive than before
          {
            ...
            value: [
              ...
              process.env.NODE_ENV === "development"
                ...
                : "connect-src 'self' https://finance.bhenning.com https://vercel.bhenning.com https://statsapi.mlb.com https://api.weather.com https://fixturedownload.com https://f5x3msep1f.execute-api.us-east-1.amazonaws.com https://client.px-cloud.net https://tzm.px-cloud.net https://ift.px-cloud.net https://collector-pxjj0cytn9.px-cloud.net https://collector-pxjj0cytn9.px-cdn.net https://collector-pxjj0cytn9.pxchk.net https://collector-pxjj0cytn9.px-client.net https://captcha.px-cdn.net https://b.px-cdn.net",
              process.env.NODE_ENV === "development"
