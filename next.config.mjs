          ...
          // Content Security Policy - much more restrictive than before
          {
            ...
            value: [
              ...
              process.env.NODE_ENV === "development"
                ...
                : "connect-src 'self' https://finance.bhenning.com https://vercel.bhenning.com https://statsapi.mlb.com https://api.weather.com https://fixturedownload.com https://f5x3msep1f.execute-api.us-east-1.amazonaws.com https://client.px-cloud.net",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
