...
export default function Docker() {
    return (
        <div>
          ...
          <p>Removes a container. Use <code>-f</code> to force remove a running container.</p>
          ...
          <pre>
            <code>docker run -d --name &lt;container_name&gt; &lt;image_name&gt;</code>
          </pre>
          ...
          <p>Docker Compose is a tool for defining and running multi-container Docker applications. Here are some basic commands:</p>
          
          <h4>Start Services</h4>
          <pre>
            <code>docker-compose up</code>
          </pre>
          <p>Starts and runs all the services defined in a <code>docker-compose.yml</code> file.</p>

          <h4>Stop Services</h4>
          <pre>
            <code>docker-compose down</code>
          </pre>
          <p>Stops and removes all containers, networks, and volumes defined in a <code>docker-compose.yml</code> file.</p>
        </div>
      );
}
