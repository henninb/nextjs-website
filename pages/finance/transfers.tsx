...
export default function Transfers() {
  ...
  const handleAddRow = async (newData: Transfer) => {
    ...
    try {
      // Construct minimal payload matching GraphQL version - omit transferId and guids
      // Server will generate transferId, guidSource, and guidDestination
      const insertThisValue: Transfer = {
        ...
        // Omit guidSource and guidDestination - server will generate them
      };
